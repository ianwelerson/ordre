...
See [Transactional Outbox](https://github.com/ianwelerson/ordre/blob/main/apps/docs/content/docs/engineering/outbox.mdx)
for how a message is declared, produced, and sent, and
[The API Runtime](https://github.com/ianwelerson/ordre/blob/main/apps/docs/content/docs/engineering/runtime.mdx)
